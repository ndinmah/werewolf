...
export const FirstNightModal = () => {
  ...
  // 1.5. Nếu nhận được dữ liệu nhận diện người tình (loverReveal)
  if (loverReveal) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-in fade-in duration-500">
        <div className="bg-darker border border-pink-500/30 rounded-2xl p-8 max-w-md w-full shadow-2xl shadow-pink-900/30 text-center">
          ...
          <div className="space-y-3">
            ...
            {loverReveal.partner ? (
              <div className="p-4 bg-dark border border-gray-800 rounded-xl shadow-inner">
                <span className="text-gray-200 font-semibold text-lg">{loverReveal.partner.name} (Người tình của bạn)</span>
              </div>
            ) : (
